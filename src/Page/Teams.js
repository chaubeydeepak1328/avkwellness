            ...
            <div style={{ background: '#f5f5f5' }}>
                <div className='mt-5 d-flex  flex-wrap gap-5 justify-content-center'>
                    {teamMembers.map((curElm, index) => {
                        return (
                            <>
                                <div key={index} class="d-flex flex-row gap-4" style={{ width: "60rem", }}>

                                    <img class="w-50" src={curElm.img} alt={curElm.img} />

                                    <div class="card-body col-5 d-flex flex-column justify-content-center">
